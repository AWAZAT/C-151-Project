...
def max_btn():
    ...
    max_label["text"] = "A maximum profit of " + str(max_profit) + " was given in the month of " + str(max_profit_month) + " ."

def min_btn():
    min_profit = min(profits)
    min_profit_index = profits.index(min_profit)
    min_profit_month = months[min_profit_index]
    min_label["text"] = "A minimum profit of " + str(min_profit) + " was given in the month of " + str(min_profit_month) + " ."

btn_max = Button(root, text = "Show Max Profit Month", command = max_btn, bg = "purple", fg = "white")
btn_max.place(relx = 0.5, rely = 0.4, anchor = CENTER)

btn_min = Button(root, text = "Show Min Profit Month", command = min_btn, bg = "purple", fg = "white")
